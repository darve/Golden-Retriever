import type { EasingFunction, EasingMap } from '../types';
...
const easeOutBounce: EasingFunction = (t, b, c, d) => {
    if ((t /= d) < (1 / 2.75)) {
...
const easeInBounce: EasingFunction = (t, b, c, d) => {
    return c - easeOutBounce(d - t, 0, c, d) + b;
};

const easeInOutBounce: EasingFunction = (t, b, c, d) => {
